...
export const preparedAssetsWithLocation: Asset[] = [
  {
    name: "Battery",
    type: "ElectricityBatteryAsset",
    realm: "smartcity",
    attributes: {
      ...
      location: {
        ...
        type: "GEO_JSONPoint",
        meta: {},
        value: { type: "Point", coordinates: [4.482259693115793, 51.91756799273] },
      },
    },
  },
  {
    ...
    attributes: {
      ...
      location: {
        ...
        type: "GEO_JSONPoint",
        meta: {},
        value: { type: "Point", coordinates: [4.4845127486877345, 51.917435642781214] },
      },
    },
  },
];

export const preparedAssetsForRules: Asset[] = [
  {
    name: "Battery",
    type: "ElectricityBatteryAsset",
    realm: "smartcity",
