...
const _home_koen_develop_openremote_ui_component_or_mwc_components_test__openremote_or_mwc_components_or_mwc_input_OrMwcInput = () => import('@openremote/or-mwc-components/or-mwc-input').then(mod => mod.OrMwcInput);
__pwRegistry.initialize({ _home_koen_develop_openremote_ui_component_or_mwc_components_test__openremote_or_mwc_components_or_mwc_input_OrMwcInput });