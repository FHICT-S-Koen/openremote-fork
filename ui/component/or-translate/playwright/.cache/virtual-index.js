...
const _home_koen_develop_openremote_ui_component_or_translate_test__openremote_or_translate_OrTranslate = () => import('@openremote/or-translate').then(mod => mod.OrTranslate);
__pwRegistry.initialize({ _home_koen_develop_openremote_ui_component_or_translate_test__openremote_or_translate_OrTranslate });